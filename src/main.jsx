...
function CanvasNode({ node, isDragging, highlighted, allNodes, selectedNodeIds, marqueeMode, shiftPressedRef, updateNode, selectNode, setDrag, setResize, createOutputNear, createManyOutputs, deleteNode, duplicateNode, openNodeMenu, startConnection, finishConnection, pushHistory, settings, textApiSettings, patchTextApiSettings, openSettings, stylePresetCenter, onOpenStylePresetCenter, viewRef, assetIndex, resourceIndex, openPromptPreview, addGenerationJobs, importShotsToTimeline, syncPipelineToLinkedNodes, sendImageToLinkedNode, appendShotsToNearestShotList, applyResultToNearestShot, handleResultShotAction, createPromptNodeFromAsset, locateResultForShot }) {
